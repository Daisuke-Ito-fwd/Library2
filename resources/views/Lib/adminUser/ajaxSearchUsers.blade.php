...
<transition name='uem' mode="out-in">
...
<transition name='uecm' mode="out-in">
    <edit-conf-modal v-show="editConfShowContent" v-on:from-child="closeModal" v-on:edit-update="updateUser"
        v-on:re-edit="reEdit">
